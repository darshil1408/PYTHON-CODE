...
multiple_student_subjects = [
    (92400133027, 'Darshil', 'PWP', 100),
    (92400133027, 'Darshil', 'ICE', 91),
    (92400133027, 'Darshil', 'DMGT', 100),
    (92400133027, 'Darshil', 'DSC', 100),
    (92400133027, 'Darshil', 'SS', 92),
    (92400133027, 'Darshil', 'COA', 95)
]
cursor.executemany('''
...
cursor.execute('''
    ...
    SET Mark = 98 
    WHERE Enrollment = 92400133027 AND Subject = 'ICE'
''')
conn.commit()
...
cursor.execute('''
    ...
    WHERE Enrollment = 92400133027 AND Subject = 'DMGT'
''')
conn.commit()
